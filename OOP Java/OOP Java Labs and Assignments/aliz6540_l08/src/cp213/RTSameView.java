...
public class RTSameView extends JPanel {
	...
	public void actionPerformed(final ActionEvent evt) {
	    ...
	    if (this.direction != 0) {
		RTSameView.this.model.setBase(this.direction + RTSameView.this.model.getBase());
		RTSameView.this.model.setHeight(this.direction + RTSameView.this.model.getHeight());
	...
	public void propertyChange(final PropertyChangeEvent evt) {
	    ...
	    // your code here
	    double avg = (RTSameView.this.model.getHeight() + RTSameView.this.model.getBase()) / 2;

	    if (avg != RTSameView.this.model.getHeight()) {
		RTSameView.this.baseHeight.setText("");
	    } else {
		String value = RTSameView.DECIMAL_FORMAT.format(avg);
		RTSameView.this.baseHeight.setText(value);
	    }
