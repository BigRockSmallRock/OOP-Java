...
public class RTSliderView extends JPanel {
	...
	public void stateChanged(final ChangeEvent e) {
	    ...
	    // your code here
	    int base = RTSliderView.this.baseSlider.getValue();
	    RTSliderView.this.model.setBase(base);
	}
    }
	...
	public void stateChanged(final ChangeEvent e) {
	    ...
	    // your code here
	    int height = RTSliderView.this.heightSlider.getValue();
	    RTSliderView.this.model.setHeight(height);
	}
    }
